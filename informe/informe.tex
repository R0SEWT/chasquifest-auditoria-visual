...
\centering
\vspace*{1.4cm}
\IfFileExists{upc-logo.png}{\includegraphics[width=3.2cm]{upc-logo.png}\\[1cm]}{\vspace{1cm}}
...
% ======================= CASOS =======================
\input{secciones/caso1}
\input{secciones/caso2}
\input{secciones/caso3}
\input{secciones/caso4}
\input{secciones/caso5}
